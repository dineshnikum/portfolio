  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Zustand", icon: FaCode, level: 75, color: "#FF6B6B" },
        { name: "Material-UI", icon: SiMui, level: 70, color: "#007FFF" },
      ],
    },
    {
      title: "Backend",
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Bootstrap", icon: SiBootstrap, level: 70, color: "#7952B3" },
      ],
    },
  ];
  ...
  return (
    <section id="skills" className="skills section">
      <div className="container">
        ...
        >
          <h2 className={`section-title animate-fade-in-up animate-stagger-1 ${inView ? 'visible' : ''}`}>
            Skills & Technologies
          </h2>

          <p className={`skills-description animate-fade-in-up animate-stagger-2 ${inView ? 'visible' : ''}`}>
              ...
              >
                ...
                <div className="skills-grid">
                  {category.skills.map((skill, skillIndex) => (
                    <div
                      key={skill.name}
                      className={`skill-card hover-scale animate-fade-in-up animate-stagger-${skillIndex + 4} ${inView ? 'visible' : ''}`}
                    >
                      <div
