...
const Projects = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            description:
                "An interactive Tic Tac Toe game featuring an intelligent AI opponent with multiple difficulty levels, game statistics, and a modern user interface.",
            image: "/images/ai-TicTacToe.png",
            technologies: ["React", "CSS3", "JavaScript", "Minimax Algorithm"],
            category: "frontend",
            github: "https://github.com/dineshnikum/Ai-TicTacToe",
            live: "https://ai-tic-tac-toe-alpha.vercel.app/",
            features: [
                "AI Opponent with Minimax Algorithm",
                "Multiple Difficulty Levels",
                "Win Detection & Game Statistics",
                "Responsive Design",
                "Interactive UI",
            ],
        },
        {
            ...
            description:
                "A admin panel for a food delivery application with user authentication, product management, shopping cart, and payment integration.",
            image: "/images/food-delivery-admin-panel.png",
            technologies: ["Node.js", "Express", "MongoDB", "JWT", "Stripe"],
            category: "fullstack",
            github: "https://github.com/dineshnikum/food-delivery__app",
            live: "https://food-delivery-admin-ewq6.onrender.com/add",
            features: [
                "User Authentication",
                "Product Management",
                "Shopping Cart",
        ...
        {
            id: 6,
            title: "Food Delivery User Panel",
            description:
                "A user panel for a food delivery application with user authentication, product management, shopping cart, and payment integration.",
